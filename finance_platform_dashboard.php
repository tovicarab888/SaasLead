<?php
/**
 * FINANCE_PLATFORM_DASHBOARD.PHP - Dashboard untuk Finance Platform (ID 10)
...
$stats_sql = "
    SELECT 
        ...
        COUNT(DISTINCT kl.developer_id) as total_developer
    FROM komisi_logs kl
...
$pending_sql = "
    ...
    WHERE kl.assigned_type = 'external' AND kl.status = 'pending'
    ORDER BY kl.created_at DESC
    LIMIT 20
";
$pending_stmt = $conn->query($pending_sql);
$pending_komisi = $pending_stmt->fetchAll();

// ========== REKENING BELUM VERIFIKASI ==========
$rekening_sql = "
    SELECT 
        m.*,
        b.nama_bank,
        b.nomor_rekening as bank_rekening,
        b.atas_nama as bank_atas_nama
    FROM marketing_team m
    LEFT JOIN banks b ON m.bank_id = b.id
    WHERE m.rekening_verified = 0 
    AND m.nomor_rekening IS NOT NULL 
    AND m.nomor_rekening != ''
    ORDER BY m.updated_at DESC
    LIMIT 10
";
$rekening_stmt = $conn->query($rekening_sql);
...
$top_marketing_sql = "
    ...
    WHERE kl.assigned_type = 'external' AND kl.status = 'cair'
    GROUP BY m.id
    ORDER BY total_nominal DESC
    LIMIT 5
";
$top_marketing_stmt = $conn->query($top_marketing_sql);
$top_marketing = $top_marketing_stmt->fetchAll();

// ========== SET VARIABLES ==========
$page_title = 'Finance Platform Dashboard';
$page_subtitle = 'Kelola Komisi External Marketing';
...
<div class="main-content">
    ...
    <div class="stats-grid">
        <div class="stat-card" style="border-left-color: var(--warning);">
            ...
            <div style="font-size: 12px; color: var(--warning); font-weight: 600;">Rp <?= number_format($stats['total_pending'] ?? 0, 0, ',', '.') ?></div>
        </div>
        ...
        <div class="stat-card" style="border-left-color: var(--success);">
            ...
            <div style="font-size: 12px; color: var(--success); font-weight: 600;">Rp <?= number_format($stats['total_cair'] ?? 0, 0, ',', '.') ?></div>
        </div>
        ...
        <div class="stat-card" style="border-left-color: var(--info);">
            ...
            <div style="font-size: 12px; color: var(--info); font-weight: 600;">Aktif</div>
        </div>
        
        <div class="stat-card" style="border-left-color: var(--primary);">
            <div class="stat-icon"><i class="fas fa-building"></i></div>
            <div class="stat-label">Total Developer</div>
            <div class="stat-value"><?= number_format($stats['total_developer'] ?? 0) ?></div>
            <div style="font-size: 12px; color: var(--primary); font-weight: 600;">Bekerja Sama</div>
        </div>
    </div>
    ...
    <div class="two-column-grid">
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <a href="finance_platform_verifikasi.php" class="table-badge" style="text-decoration: none;">Lihat Semua <i class="fas fa-arrow-right"></i></a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="finance_platform_verifikasi.php?id=<?= $komisi['id'] ?>" class="action-btn edit" title="Verifikasi">
                                        <i class="fas fa-check-circle"></i>
                                    </a>
                                </div>
                            </td>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <a href="finance_platform_rekening.php" class="table-badge" style="text-decoration: none;">Lihat Semua <i class="fas fa-arrow-right"></i></a>
            </div>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?= htmlspecialchars($rek['nama_lengkap'] ?? '-') ?></strong></td>
                            <td><?= htmlspecialchars($rek['nama_bank'] ?? '-') ?></td>
                            <td><?= htmlspecialchars($rek['nomor_rekening'] ?? '-') ?></td>
                            <td>
                                <div class="action-buttons">
                                    <a href="finance_platform_rekening.php?id=<?= $rek['id'] ?>" class="action-btn edit" title="Verifikasi">
                                        <i class="fas fa-check-circle"></i>
                                    </a>
                                </div>
                            </td>
    ...
    <div class="two-column-grid">
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <a href="finance_platform_laporan.php" class="table-badge" style="text-decoration: none;">Lihat Laporan <i class="fas fa-arrow-right"></i></a>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                <h3><i class="fas fa-crown" style="color: #FFD700;"></i> Top Marketing External</h3>
            </div>
    ...
    <!-- FOOTER -->
    <div class="footer">
        <p>© <?= date('Y') ?> LeadEngine - Finance Platform Dashboard v2.0</p>
    </div>
