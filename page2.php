...
<head>
    ...
    <title>Lead Engine — Cara Kerja</title>
    ...
    <style>
        * {
        ...
        .bg-gradient {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 80% 20%, rgba(232, 92, 63, 0.03) 0%, transparent 45%),
                        radial-gradient(circle at 20% 80%, rgba(10, 46, 36, 0.05) 0%, transparent 50%),
        ...
        .flow-container {
            ...
            animation: rotateFlow 12s ease-in-out infinite;
        }
        ...
        .flow-node {
            ...
            animation: flowNodeFloat 2.5s ease-in-out infinite;
        ...
        .flow-node.active {
            ...
            color: white;
            box-shadow: 0 20px 30px -5px rgba(232,92,63,0.3);
        }
        ...
        @media (max-height: 700px) {
            ...
            .flow-node { width: 48px; height: 48px; font-size: 20px; }
        ...
        @media (max-height: 600px) {
            ...
            .flow-node { width: 44px; height: 44px; font-size: 18px; }
            .flow-node i { font-size: 18px; }
            .flow-label { font-size: 9px; gap: 16px; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            <a href="page1.php" class="back-btn">
            ...
            <div class="content">
                <div class="illustration">
                    <div class="flow-container">
                        <div class="flow-row">
                            <div class="flow-node active"><i class="fas fa-bullhorn"></i></div>
                            <i class="fas fa-arrow-right flow-arrow"></i>
                            <div class="flow-node"><i class="fas fa-file-alt"></i></div>
                            <i class="fas fa-arrow-right flow-arrow"></i>
                            <div class="flow-node"><i class="fas fa-user-plus"></i></div>
                        </div>
                        ...
                        <div class="flow-row" style="margin-top: 16px;">
                            <div class="flow-node"><i class="fas fa-shuffle"></i></div>
                            <i class="fas fa-arrow-right flow-arrow"></i>
                            <div class="flow-node"><i class="fas fa-chart-pie"></i></div>
                            <i class="fas fa-arrow-right flow-arrow"></i>
                            <div class="flow-node"><i class="fas fa-user-tie"></i></div>
                        </div>
                        <div class="flow-label">
                            <span>Assign</span>
                            <span>Tracking</span>
                ...
                <h1 class="headline">End-to-end<br>Lead Flow</h1>
                <p class="subheadline">Dari iklan hingga closing — satu alur terintegrasi</p>
                
                <div class="points">
                    <div class="point">
                        <div class="point-icon"><i class="fas fa-cloud-upload-alt"></i></div>
                        <span class="point-text">Lead masuk otomatis dari Meta, TikTok, Google</span>
                    </div>
                    <div class="point">
                        <div class="point-icon"><i class="fas fa-clock"></i></div>
                        <span class="point-text">Assign real-time ke tim marketing</span>
                    </div>
                    <div class="point">
                        <div class="point-icon"><i class="fas fa-chart-line"></i></div>
                        <span class="point-text">Tracking pixel untuk optimasi iklan</span>
                    </div>
                </div>
            </div>
            
            <div>
                <button class="btn-premium" onclick="window.location.href='page3.php'">
                    <span>Lihat Value</span>
