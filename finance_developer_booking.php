...
// Hanya Manager Developer dan Finance yang bisa akses halaman ini
if (!isManagerDeveloper() && !isFinance()) {
    header('HTTP/1.0 403 Forbidden');
    die('Akses ditolak. Halaman ini hanya untuk Manager Developer dan Finance.');
}
